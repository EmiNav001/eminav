        ...
        <div class="contact-info-item">
          ...
          <div>
            ...
            <div class="contact-info-value" style="display:flex;flex-direction:column;gap:12px">
              <span style="font-size:0.9375rem;color:rgba(255,255,255,0.6)">Help others find the right care</span>
              <div style="display:flex;gap:12px;flex-wrap:wrap">
                ...
                <a href="#" onclick="event.preventDefault();window.open('https://wa.me/?text=' + encodeURIComponent('Check out EmiNav - helps you find the right healthcare facility in Lagos & Nairobi!\n\nDownload: https://eminav.com/EmiNav_How_It_Works.pdf\n\nVisit: eminav.com'))" style="display:inline-flex;align-items:center;gap:6px;padding:8px 16px;background:rgba(37,211,102,0.2);border:1px solid #25D366;color:#25D366;border-radius:6px;text-decoration:none;font-size:0.9375rem;font-weight:600;transition:all 0.2s" onmouseover="this.style.background='rgba(37,211,102,0.3)'" onmouseout="this.style.background='rgba(37,211,102,0.2)'">
