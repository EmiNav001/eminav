...
export default function Home() {
  useEffect(() => {
    // Client-side JavaScript runs here after component mounts
// Scroll reveal
...
:root {
  ...
  <nav>
    ...
    <ul className="nav-links">
      ...
      <li><a href="#hero" className="nav-cta">Find Care →</a></li>
    </ul>
  </nav>
  ...
  <section id="hero">
    ...
    <div className="hero-left">
      ...
      <div className="hero-actions">
        <a href="#find-care" className="btn-primary" onclick="document.querySelector && (window._city='Lagos')">
        ...
        <a href="#find-care" className="btn-secondary" onclick="document.querySelector && (window._city='Nairobi')" style="border-color:rgba(255,255,255,0.35);">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
          Nairobi
        </a>
      </div>
      ...
      <div className="hero-stats">
        ...
        <div>
          ...
          <div className="hero-stat-label">Intent Types</div>
        </div>
        <div>
  ...
  <path d="M18 25.5 L21 25.5 L22.5 21 L24.5 30 L26.5 21 L28.5 30 L30 25.5 L34 25.5"
    fill="none" stroke="#1BA8B8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div className="mockup-question">What's happening?</div>
        <div className="mockup-intents">
          <div className="mockup-intent">
            <div className="mockup-intent-icon" style="background:rgba(239,68,68,0.15)">🚨</div>
            <span className="mockup-intent-text">Accident / Trauma</span>
            <span className="mockup-intent-urgent">URGENT</span>
          </div>
          <div className="mockup-intent">
            <div className="mockup-intent-icon" style="background:rgba(236,72,153,0.12)">🤰</div>
            <span className="mockup-intent-text">Labor / Pregnancy</span>
            <span className="mockup-intent-urgent">URGENT</span>
          </div>
          <div className="mockup-intent">
            <div className="mockup-intent-icon" style="background:rgba(245,158,11,0.12)">👶</div>
            <span className="mockup-intent-text">Child Emergency</span>
          </div>
          <div className="mockup-intent">
            <div className="mockup-intent-icon" style="background:rgba(99,102,241,0.12)">🧠</div>
            <span className="mockup-intent-text">Stroke Symptoms</span>
          </div>
          <div className="mockup-intent">
            <div className="mockup-intent-icon" style="background:rgba(16,185,129,0.12)">🔬</div>
            <span className="mockup-intent-text">Diagnostic Center</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <div className="trusted-bar">
    <span className="trusted-label">Currently serving</span>
    <div className="trusted-cities">
      <div className="trusted-city">
      ...
      <div className="trusted-city" style="opacity:0.45">
        <span className="city-dot" style="background:#CBD5E1"></span>
  ...
  <section id="how-it-works">
    <div className="reveal">
      <div className="section-label">The EmiNav Difference</div>
      <h2 className="section-title">Decision-first,<br/>not search-first.</h2>
      <p className="section-sub">Google shows you 50 clinics. EmiNav shows you the right one for your specific situation.</p>
    </div>
      ...
      <div className="hiw-steps reveal">
        <div className="hiw-step">
          ...
          <div className="hiw-step-content">
            <div className="hiw-step-title">State your intent</div>
            <div className="hiw-step-desc">Tell us what you need — emergency, labor, X-ray, pharmacy, or more. Not keywords. Real situations.</div>
          </div>
        </div>
        <div className="hiw-step">
          <div className="hiw-step-number">2</div>
          <div className="hiw-step-content">
            <div className="hiw-step-title">We filter by capability</div>
            <div className="hiw-step-desc">Our database tracks what facilities can actually do — not what they claim. We only show you what matches.</div>
          </div>
        </div>
        <div className="hiw-step">
          <div className="hiw-step-number">3</div>
          <div className="hiw-step-content">
            <div className="hiw-step-title">Get ranked results</div>
            <div className="hiw-step-desc">Results ranked by distance, rating, cost, and availability. Every facility is manually verified.</div>
          </div>
        </div>
        <div className="hiw-step">
          <div className="hiw-step-number">4</div>
          <div className="hiw-step-content">
            <div className="hiw-step-title">Call or get directions</div>
            <div className="hiw-step-desc">One tap to call, one tap for directions. No friction when seconds matter.</div>
          </div>
        </div>
      </div>

      <div className="compare-panel reveal">
        <div className="compare-title">EmiNav vs. Traditional Search</div>
        <div className="compare-row">
          <div className="compare-card bad">
            <div className="compare-card-label">❌ Google Search</div>
            <div className="compare-item"><span className="compare-icon">✗</span> 50+ unfiltered results</div>
            <div className="compare-item"><span className="compare-icon">✗</span> No capability data</div>
            <div className="compare-item"><span className="compare-icon">✗</span> No cost estimates</div>
            <div className="compare-item"><span className="compare-icon">✗</span> Guesswork & phone calls</div>
            <div className="compare-item"><span className="compare-icon">✗</span> Time wasted in emergencies</div>
          </div>
          <div className="compare-card good">
            <div className="compare-card-label">✓ EmiNav</div>
            <div className="compare-item"><span className="compare-icon">✓</span> Intent-filtered results</div>
            <div className="compare-item"><span className="compare-icon">✓</span> Verified capabilities</div>
            <div className="compare-item"><span className="compare-icon">✓</span> Cost estimates shown</div>
            <div className="compare-item"><span className="compare-icon">✓</span> One-tap call & directions</div>
            <div className="compare-item"><span className="compare-icon">✓</span> Right care, right now</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="about">
    ...
    <div className="about-grid">
      <div className="about-left reveal">
        <div className="section-label">About EmiNav</div>
        <h2 className="section-title">Built for the African healthcare reality.</h2>
        ...
        <p className="about-body" style="margin-top:16px;">
        ...
        <div className="cities-coverage">
          <div className="city-badge">
            <span className="city-badge-flag">🇰🇪</span>
            Nairobi, Kenya
          </div>
          <div className="city-badge">
            <span className="city-badge-flag">🇳🇬</span>
      ...
      <div className="about-right reveal">
        <div className="about-right-card">
          <div className="about-vision-label">Our Mission</div>
          ...
          <div className="about-founders">
            ...
            <div>
              <div className="founder-info-name">EmiNav Team</div>
              <div className="founder-info-role">Building Africa's health layer</div>
            </div>
          </div>
        </div>
        ...
        <div className="about-pillars">
          <div className="about-pillar">
            ...
            <div>
              <div className="about-pillar-title">Verified, Not Just Listed</div>
              <div className="about-pillar-desc">Every facility is manually verified. We confirm capabilities before they appear on EmiNav.</div>
            </div>
          </div>
          <div className="about-pillar">
            <div className="about-pillar-icon">🌍</div>
            <div>
              <div className="about-pillar-title">Built for Africa</div>
              <div className="about-pillar-desc">Designed for the realities of African healthcare — from cost transparency to local language support.</div>
            </div>
          </div>
          <div className="about-pillar">
            <div className="about-pillar-icon">⚡</div>
            <div>
              <div className="about-pillar-title">Speed When It Matters</div>
              <div className="about-pillar-desc">In emergencies, seconds count. EmiNav is optimized for fast, clear decisions.</div>
            </div>
          </div>
        </div>
      </div>
  ...
  <section id="contact">
    <div className="reveal">
      ...
      <p className="section-sub">Whether you're a healthcare facility, potential partner, or just have questions — reach out.</p>
    </div>
      ...
      <div className="contact-info-block reveal">
        <div className="contact-info-item">
          ...
          <div>
            ...
            <div className="contact-info-value">hello@eminav.com</div>
          </div>
        </div>
        <div className="contact-info-item">
          <div className="contact-icon">📍</div>
          <div>
            <div className="contact-info-label">Operating In</div>
            <div className="contact-info-value">Nairobi, Kenya & Lagos, Nigeria</div>
          </div>
        </div>
        <div className="contact-info-item">
          <div className="contact-icon">🏥</div>
          <div>
            <div className="contact-info-label">For Healthcare Facilities</div>
            <div className="contact-info-value">Get listed on EmiNav — contact us to start the verification process.</div>
          </div>
        </div>
        <div className="contact-info-item">
          <div className="contact-icon">🤝</div>
          <div>
            <div className="contact-info-label">Partnerships</div>
            <div className="contact-info-value">Open to partnerships with health networks, insurers, and NGOs.</div>
          </div>
        </div>
      </div>
      ...
      <div className="contact-form reveal">
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <input type="text" className="form-input" placeholder="Ada" />
          </div>
          <div className="form-group">
            <label className="form-label">Last Name</label>
            <input type="text" className="form-input" placeholder="Okafor" />
          </div>
        </div>
        <div className="form-group">
          <label className="form-label">Email</label>
          <input type="email" className="form-input" placeholder="ada@example.com" />
        </div>
        <div className="form-group">
  ...
  <footer>
    ...
    <div className="footer-bottom">
      <div className="footer-bottom-text">© 2026 EmiNav. All rights reserved.</div>
      <div className="footer-cities">
        <div className="footer-city"><span className="footer-city-dot"></span>Nairobi</div>
        <div className="footer-city"><span className="footer-city-dot"></span>Lagos</div>
      </div>
    </div>
  </footer>
