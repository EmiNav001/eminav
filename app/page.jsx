...
export default function Home() {
  ...
  <!-- FIND CARE SECTION                     -->
  <!-- ══════════════════════════════════════ -->
  <section id="find-care" style="min-height: 100vh; background: #F7F9F9; padding: 80px 5% 120px; display: none;">
    <div style="max-width: 1200px; margin: 0 auto;">
      
      <!-- Selected City Display -->
      <div id="city-display" style="text-align: center; margin-bottom: 60px;">
        <div style="display: inline-flex; align-items: center; gap: 8px; background: rgba(13,110,110,0.1); border: 1px solid rgba(13,110,110,0.3); padding: 10px 24px; border-radius: 100px;">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#0D6E6E" stroke-width="2.5" stroke-linecap="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
          <span id="selected-city" style="font-weight: 600; color: #0D6E6E; font-size: 1rem;"></span>
        </div>
        <button onclick="document.getElementById('find-care').style.display='none'; window.scrollTo({top:0,behavior:'smooth'})" style="margin-left: 20px; background: transparent; border: 1px solid #E5E7EB; color: #6B7280; padding: 8px 20px; border-radius: 8px; font-size: 0.875rem; cursor: pointer; font-family: 'DM Sans', sans-serif;">Change City</button>
      </div>
      ...
      <div style="text-align: center; margin-bottom: 50px;">
        ...
        <h2 style="font-family: 'DM Serif Display', serif; font-size: clamp(2rem, 4vw, 2.5rem); color: #0A1628; letter-spacing: -0.03em; line-height: 1.15; margin-bottom: 16px;">Select Your Situation</h2>
        <p style="font-size: 1.05rem; color: #6B7280; line-height: 1.7; max-width: 600px; margin: 0 auto;">We'll show you facilities that can actually help with your specific need.</p>
      </div>
      ...
      <div id="intent-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px; margin-bottom: 60px;">
        ...
        <!-- Medical Emergency -->
        <div className="intent-card urgent" data-intent="emergency" onclick="selectIntent('emergency', 'Medical Emergency')" style="background: linear-gradient(135deg, #FEE2E2 0%, #FECACA 100%); border: 2px solid #FCA5A5; border-radius: 16px; padding: 24px; cursor: pointer; transition: all 0.2s; position: relative; overflow: hidden;">
          <div style="position: absolute; top: 10px; right: 10px; background: #DC2626; color: white; font-size: 0.65rem; font-weight: 700; padding: 4px 10px; border-radius: 100px; letter-spacing: 0.05em;">URGENT</div>
          <div style="font-size: 2.5rem; margin-bottom: 12px;">🚑</div>
          <div style="font-weight: 600; font-size: 1.1rem; color: #0A1628; margin-bottom: 6px;">Medical Emergency</div>
          <div style="font-size: 0.85rem; color: #6B7280; line-height: 1.5;">Cardiac, severe pain, breathing issues, injuries</div>
        </div>

        <!-- Labor / Pregnancy -->
        <div className="intent-card urgent" data-intent="labor" onclick="selectIntent('labor', 'Labor / Pregnancy')" style="background: linear-gradient(135deg, #FCE7F3 0%, #FBCFE8 100%); border: 2px solid #F9A8D4; border-radius: 16px; padding: 24px; cursor: pointer; transition: all 0.2s; position: relative;">
          ...
          <div style="font-size: 2.5rem; margin-bottom: 12px;">🤰</div>
          <div style="font-weight: 600; font-size: 1.1rem; color: #0A1628; margin-bottom: 6px;">Labor / Pregnancy</div>
          <div style="font-size: 0.85rem; color: #6B7280; line-height: 1.5;">Contractions, delivery, maternity care</div>
        </div>

        <!-- Child Emergency -->
        <div className="intent-card urgent" data-intent="child" onclick="selectIntent('child', 'Child Emergency')" style="background: linear-gradient(135deg, #FEF3C7 0%, #FDE68A 100%); border: 2px solid #FCD34D; border-radius: 16px; padding: 24px; cursor: pointer; transition: all 0.2s; position: relative;">
          ...
          <div style="font-size: 0.85rem; color: #6B7280; line-height: 1.5;">Pediatric emergencies, high fever, injuries</div>
        </div>

        <!-- Stroke Symptoms -->
        <div className="intent-card urgent" data-intent="stroke" onclick="selectIntent('stroke', 'Stroke Symptoms')" style="background: linear-gradient(135deg, #FEE2E2 0%, #FECACA 100%); border: 2px solid #FCA5A5; border-radius: 16px; padding: 24px; cursor: pointer; transition: all 0.2s; position: relative;">
          <div style="position: absolute; top: 10px; right: 10px; background: #DC2626; color: white; font-size: 0.65rem; font-weight: 700; padding: 4px 10px; border-radius: 100px;">URGENT</div>
          <div style="font-size: 2.5rem; margin-bottom: 12px;">🧠</div>
          <div style="font-weight: 600; font-size: 1.1rem; color: #0A1628; margin-bottom: 6px;">Stroke Symptoms</div>
          <div style="font-size: 0.85rem; color: #6B7280; line-height: 1.5;">Facial drooping, numbness, speech issues</div>
        </div>

        <!-- Dental Emergency -->
        <div className="intent-card" data-intent="dental" onclick="selectIntent('dental', 'Dental Emergency')" style="background: linear-gradient(135deg, #FEF3C7 0%, #FDE68A 100%); border: 2px solid #FCD34D; border-radius: 16px; padding: 24px; cursor: pointer; transition: all 0.2s; position: relative;">
          <div style="position: absolute; top: 10px; right: 10px; background: #F59E0B; color: white; font-size: 0.65rem; font-weight: 700; padding: 4px 10px; border-radius: 100px;">URGENT</div>
          <div style="font-size: 2.5rem; margin-bottom: 12px;">🦷</div>
          <div style="font-weight: 600; font-size: 1.1rem; color: #0A1628; margin-bottom: 6px;">Dental Emergency</div>
          <div style="font-size: 0.85rem; color: #6B7280; line-height: 1.5;">Severe toothache, broken tooth, abscess</div>
        </div>

        <!-- Ambulance Service -->
        <div className="intent-card" data-intent="ambulance" onclick="selectIntent('ambulance', 'Ambulance Service')" style="background: linear-gradient(135deg, #FEE2E2 0%, #FECACA 100%); border: 2px solid #FCA5A5; border-radius: 16px; padding: 24px; cursor: pointer; transition: all 0.2s; position: relative;">
          <div style="position: absolute; top: 10px; right: 10px; background: #DC2626; color: white; font-size: 0.65rem; font-weight: 700; padding: 4px 10px; border-radius: 100px;">URGENT</div>
          <div style="font-size: 2.5rem; margin-bottom: 12px;">🚨</div>
          <div style="font-weight: 600; font-size: 1.1rem; color: #0A1628; margin-bottom: 6px;">Ambulance Service</div>
          <div style="font-size: 0.85rem; color: #6B7280; line-height: 1.5;">Need emergency transport now</div>
        </div>

        <!-- Pharmacy -->
        <div className="intent-card" data-intent="pharmacy" onclick="selectIntent('pharmacy', 'Need Pharmacy')" style="background: white; border: 2px solid #E5E7EB; border-radius: 16px; padding: 24px; cursor: pointer; transition: all 0.2s;">
          <div style="font-size: 2.5rem; margin-bottom: 12px;">💊</div>
          <div style="font-weight: 600; font-size: 1.1rem; color: #0A1628; margin-bottom: 6px;">Need Pharmacy</div>
          <div style="font-size: 0.85rem; color: #6B7280; line-height: 1.5;">Medications, prescriptions, over-the-counter</div>
        </div>

        <!-- Diagnostic -->
        <div className="intent-card" data-intent="diagnostic" onclick="selectIntent('diagnostic', 'Diagnostic Center')" style="background: white; border: 2px solid #E5E7EB; border-radius: 16px; padding: 24px; cursor: pointer; transition: all 0.2s;">
          <div style="font-size: 2.5rem; margin-bottom: 12px;">🔬</div>
          <div style="font-weight: 600; font-size: 1.1rem; color: #0A1628; margin-bottom: 6px;">Diagnostic Center</div>
          <div style="font-size: 0.85rem; color: #6B7280; line-height: 1.5;">X-rays, scans, lab tests, imaging</div>
        </div>

        <!-- Vaccination -->
        <div className="intent-card" data-intent="vaccination" onclick="selectIntent('vaccination', 'Vaccination')" style="background: white; border: 2px solid #E5E7EB; border-radius: 16px; padding: 24px; cursor: pointer; transition: all 0.2s;">
          <div style="font-size: 2.5rem; margin-bottom: 12px;">💉</div>
          <div style="font-weight: 600; font-size: 1.1rem; color: #0A1628; margin-bottom: 6px;">Vaccination</div>
          <div style="font-size: 0.85rem; color: #6B7280; line-height: 1.5;">Immunizations, vaccines, boosters</div>
        </div>

        <!-- General Consultation -->
        <div className="intent-card" data-intent="consultation" onclick="selectIntent('consultation', 'General Consultation')" style="background: white; border: 2px solid #E5E7EB; border-radius: 16px; padding: 24px; cursor: pointer; transition: all 0.2s;">
          <div style="font-size: 2.5rem; margin-bottom: 12px;">👨‍⚕️</div>
          <div style="font-weight: 600; font-size: 1.1rem; color: #0A1628; margin-bottom: 6px;">General Consultation</div>
          <div style="font-size: 0.85rem; color: #6B7280; line-height: 1.5;">Doctor checkup, routine visit, symptoms</div>
        </div>

        <!-- Mental Health -->
        <div className="intent-card" data-intent="mental" onclick="selectIntent('mental', 'Mental Health')" style="background: white; border: 2px solid #E5E7EB; border-radius: 16px; padding: 24px; cursor: pointer; transition: all 0.2s;">
          <div style="font-size: 2.5rem; margin-bottom: 12px;">🧘</div>
          <div style="font-weight: 600; font-size: 1.1rem; color: #0A1628; margin-bottom: 6px;">Mental Health</div>
          <div style="font-size: 0.85rem; color: #6B7280; line-height: 1.5;">Therapy, counseling, psychological support</div>
        </div>

        <!-- Not Sure -->
        <div className="intent-card" data-intent="all" onclick="selectIntent('all', 'Show All Facilities')" style="background: linear-gradient(135deg, #E0F2FE 0%, #BAE6FD 100%); border: 2px solid #7DD3FC; border-radius: 16px; padding: 24px; cursor: pointer; transition: all 0.2s;">
          <div style="font-size: 2.5rem; margin-bottom: 12px;">❓</div>
          <div style="font-weight: 600; font-size: 1.1rem; color: #0A1628; margin-bottom: 6px;">Not Sure</div>
          <div style="font-size: 0.85rem; color: #6B7280; line-height: 1.5;">Show me all nearby facilities</div>
        </div>
      ...
      <div id="results-section" style="display: none;">
        <div style="text-align: center; margin-bottom: 40px;">
          <h3 id="results-title" style="font-family: 'DM Serif Display', serif; font-size: 1.8rem; color: #0A1628; margin-bottom: 12px;"></h3>
          <p id="results-subtitle" style="color: #6B7280; font-size: 0.95rem;"></p>
        </div>
  ...
  <script>
    ...
    // Intent selection
    function selectIntent(intentType, intentName) {
      // Hide intent grid, show results
      document.getElementById('intent-grid').style.display = 'none';
      document.getElementById('results-section').style.display = 'block';
      
      const city = document.getElementById('selected-city').textContent;
      document.getElementById('results-title').textContent = intentName + ' in ' + city;
      document.getElementById('results-subtitle').textContent = 'Showing verified facilities that can handle your situation';
      
      // Fetch and display results
      fetchFacilities(city, intentType);
    ...
    async function fetchFacilities(city, intent) {
      const container = document.getElementById('results-container');
      container.innerHTML = '<div style="text-align:center;padding:60px 20px;color:#6B7280;font-size:1.1rem;">🔍 Searching for facilities...</div>';
      ...
      setTimeout(() => {
        container.innerHTML = `
          <div style="text-align:center;padding:60px 20px;">
            ...
            <h3 style="font-family:'DM Serif Display',serif;font-size:1.5rem;color:#0A1628;margin-bottom:12px;">Connect Your Database</h3>
            <p style="color:#6B7280;max-width:500px;margin:0 auto 24px;">Add your Supabase credentials to see real facility data here.</p>
            <div style="background:#E6F4F4;border:1px solid #0D6E6E;border-radius:12px;padding:20px;max-width:600px;margin:0 auto;text-align:left;">
              <div style="font-weight:600;color:#0A1628;margin-bottom:8px;">Next Steps:</div>
              <div style="color:#6B7280;font-size:0.9rem;line-height:1.6;">
                1. Add facilities to your Supabase database<br>
                2. Connect the API in this component<br>
