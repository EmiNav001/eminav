...
export default function Home() {
  ...
  <footer>
    <div class="footer-grid">
      <div>
        <div class="footer-brand-name"><img src="data:image/svg+xml;base64," alt="EmiNav" style="height:64px;width:auto;" /></div>
  ...
  <script>
    ...
    if (container) {
      ...
      // Run scripts after content loads
      setTimeout(() => {
        // Scroll reveal
        const reveals = document.querySelectorAll('.reveal');
        const observer = new IntersectionObserver((entries) => {
